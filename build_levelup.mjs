...
`;
fs.writeFileSync("src/components/ui/LevelUpManager.tsx", code.trim());

// 2. Install canvas-confetti
// I will just mock the confetti logic since I might not be able to install packages safely right now, wait I CAN run npm!
// Let us add canvas-confetti. If it fails, I will use CSS. I will use `npm install canvas-confetti @types/canvas-confetti`

// 3. Inject into App.tsx
let app = fs.readFileSync("src/App.tsx", "utf-8");
if (!app.includes("LevelUpManager")) {
  app = app.replace(
    "import { PublicProfileModal } from \x27@/components/ui/PublicProfileModal\x27;",
    "import { PublicProfileModal } from \x27@/components/ui/PublicProfileModal\x27;\nimport { LevelUpManager } from \x27@/components/ui/LevelUpManager\x27;"
  );
  app = app.replace(
    "<PublicProfileModal />",
    "<PublicProfileModal />\n        <LevelUpManager />"
...
console.log("Level Up Manager built.");
