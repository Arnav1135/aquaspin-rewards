...
export function BlackjackGame({ onClose }: BlackjackGameProps) {
  ...
  return (
    <ErrorBoundary name="BlackjackGame">
      <div className="flex flex-col-reverse lg:flex-row gap-6 p-4 max-w-5xl mx-auto w-full min-h-[calc(100vh-120px)] items-stretch border border-cyan-400/40 shadow-[0_0_15px_rgba(34,211,238,0.15)] rounded-2xl" style={{ background: 'linear-gradient(135deg, #0e0b2e 0%, #12082a 50%, #0a1040 100%)' }}>
          ...
          <div className="space-y-2">
            ...
            {gameState === 'playing' && (
              <div className="flex gap-2">
                <Button variant="outline" className="flex-1" onClick={handleHit}>Hit</Button>
