...
export function CrashGame({ onClose }: CrashGameProps) {
  ...
  return (
    ...
    >
      ...
      <Card className="flex-1 min-w-0 w-full flex flex-col relative min-h-[400px] xl:min-h-[400px] xl:min-h-[500px] bg-slate-950 border border-slate-900 rounded-2xl overflow-hidden z-20">
