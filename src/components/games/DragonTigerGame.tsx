...
export function DragonTigerGame({ onClose }: any) {
  ...
  return (
    <ErrorBoundary name="DragonTigerGame">
      <div className="flex flex-col-reverse lg:flex-row gap-6 p-4 max-w-5xl mx-auto w-full min-h-[calc(100dvh-120px)] items-stretch border border-cyan-400/40 shadow-[0_0_15px_rgba(34,211,238,0.15)] rounded-2xl" style={{ background: 'linear-gradient(135deg, #1c0a08 0%, #0a100a 50%, #080a1c 100%)' }}>
