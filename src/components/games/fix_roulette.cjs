...
const file = 'd:/Web App - Aqua Blue/src/components/games/RouletteGame.tsx';
...
const replacements = [
  [/<mesh position={\[0, -0\.2, 0\]} receiveShadow>\s*<cylinderGeometry args={\[4\.6, 4\.8, 0\.8, 64, 1, true\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, -0.2, 0]} receiveShadow geometry={GEO_BOWL_BASE} material={MAT_BOWL_BASE} />'],
  [/<mesh position={\[0, 0\.22, 0\]} receiveShadow>\s*<torusGeometry args={\[4\.5, 0\.1, 16, 64\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.22, 0]} receiveShadow geometry={GEO_BOWL_TRIM} material={MAT_BOWL_TRIM} />'],
  [/<mesh position={\[0, -0\.1, 0\]} receiveShadow>\s*<cylinderGeometry args={\[4\.4, 3\.2, 0\.6, 64, 1, true\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, -0.1, 0]} receiveShadow geometry={GEO_BOWL_SLOPE} material={MAT_BOWL_SLOPE} />'],
  [/<mesh key={i} position={\[x, 0\.05, z\]} rotation={\[Math\.PI \/ 2, 0, angle\]} castShadow>\s*<octahedronGeometry args={\[0\.08, 0\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh key={i} position={[x, 0.05, z]} rotation={[Math.PI / 2, 0, angle]} castShadow geometry={GEO_DEFLECTOR} material={MAT_DEFLECTOR} />'],

  [/<mesh position={\[0, 0, 0\]} receiveShadow>\s*<cylinderGeometry args={\[3\.2, 3\.2, 0\.1, 64\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0, 0]} receiveShadow geometry={GEO_WHEEL_BASE} material={MAT_WHEEL_BASE} />'],
  [/<mesh position={\[0, 0\.05, 0\]} receiveShadow>\s*<torusGeometry args={\[2\.9, 0\.03, 16, 64\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.05, 0]} receiveShadow geometry={GEO_WHEEL_RING} material={MAT_WHEEL_RING} />'],
  [/<mesh position={\[0, 0\.2, 0\]} receiveShadow castShadow>\s*<cylinderGeometry args={\[1\.2, 1\.6, 0\.4, 32\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.2, 0]} receiveShadow castShadow geometry={GEO_WHEEL_TURRET} material={MAT_WHEEL_TURRET} />'],
  [/<mesh position={\[0, 0\.4, 0\]} receiveShadow castShadow>\s*<cylinderGeometry args={\[0\.3, 1\.2, 0\.15, 32\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.4, 0]} receiveShadow castShadow geometry={GEO_WHEEL_TURRET_TOP} material={MAT_WHEEL_TURRET_TOP} />'],
  [/<mesh position={\[0, 0\.8, 0\]} receiveShadow castShadow>\s*<cylinderGeometry args={\[0\.15, 0\.2, 0\.8, 16\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.8, 0]} receiveShadow castShadow geometry={GEO_SPINDLE} material={MAT_SPINDLE} />'],
  [/<mesh position={\[0, 1\.2, 0\]} receiveShadow castShadow>\s*<sphereGeometry args={\[0\.25, 32, 32\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 1.2, 0]} receiveShadow castShadow geometry={GEO_SPINDLE_TOP} material={MAT_SPINDLE} />'],
  
  [/<mesh key={i} position={\[Math\.sin\(angle\) \* 0\.4, 0\.8, Math\.cos\(angle\) \* 0\.4\]} rotation={\[Math\.PI \/ 2, 0, angle\]} castShadow>\s*<cylinderGeometry args={\[0\.04, 0\.04, 0\.8, 8\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh key={i} position={[Math.sin(angle) * 0.4, 0.8, Math.cos(angle) * 0.4]} rotation={[Math.PI / 2, 0, angle]} castShadow geometry={GEO_CROSSBAR} material={MAT_SPINDLE} />'],
  
  [/<mesh position={\[0, 0\.06, -2\.6\]} receiveShadow>\s*<boxGeometry args={\[0\.42, 0\.02, 0\.5\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.06, -2.6]} receiveShadow geometry={GEO_NUMBER_PLATE} material={isRed ? MAT_NUMBER_PLATE_RED : isGreen ? MAT_NUMBER_PLATE_GREEN : MAT_NUMBER_PLATE_BLACK} />'],
  [/<mesh position={\[0, 0\.04, -2\.1\]} receiveShadow>\s*<boxGeometry args={\[0\.33, 0\.04, 0\.5\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0, 0.04, -2.1]} receiveShadow geometry={GEO_POCKET} material={MAT_POCKET} />'],
  [/<mesh position={\[0\.22, 0\.08, -2\.35\]} receiveShadow castShadow rotation={\[0, SECTOR_ANGLE \/ 2, 0\]}>\s*<boxGeometry args={\[0\.02, 0\.1, 1\.0\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh position={[0.22, 0.08, -2.35]} receiveShadow castShadow rotation={[0, SECTOR_ANGLE / 2, 0]} geometry={GEO_DIVIDER} material={MAT_SPINDLE} />'],
  
  [/<mesh ref={ballRef} castShadow receiveShadow position={\[0, 10, 0\]}>\s*<sphereGeometry args={\[0\.12, 32, 32\]} \/>\s*<meshPhysicalMaterial [^>]+\/>\s*<\/mesh>/g, '<mesh ref={ballRef} castShadow receiveShadow position={[0, 10, 0]} geometry={GEO_BALL} material={MAT_BALL} />'],
];
