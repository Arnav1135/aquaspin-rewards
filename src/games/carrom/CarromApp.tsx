            ...
            >
              ...
              <div className="flex flex-col gap-4 w-64">
                ...
                <button
                  ...
                  className="py-4 px-6 rounded-xl bg-[#E91E63]/20 hover:bg-[#E91E63]/30 border border-[#E91E63]/50 text-[#E91E63] font-bold transition-all hover:scale-105 active:scale-95"
                >
                  🎮 MULTIPLAYER LOBBY
                </button>
              </div>
